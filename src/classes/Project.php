...
class Project
{
    ...
    {
        return self::strToSlug(
            $str,
            array(
                "delimiter"    => $delimiter,
                "replacements" => array('/\//i' => '')
            )
        );
    }

    /**
     * Custom function to convert string to Slug with transliteration
     * 
     * @param string $str     The string to be sluged
     * @param array  $options The options array for the slug operation
     * 
     * @return string
     */
